...
For complete details follow the [documentation](https://mcuxpresso.nxp.com/mcux-vscode/latest/index.html) section.
...
* Dependency tools and software components can be installed using [MCUXpresso Installer](https://mcuxpresso.nxp.com/mcux-vscode/latest/MCUXpresso-Installer.html)
